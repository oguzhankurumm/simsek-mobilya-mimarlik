...
export const config = {
  matcher: [
    ...
    "/((?!api|admin|urunler|sepet|odeme|hesabim|menu|giris|kayit|sifremi-unuttum|siparis-takibi|mesafeli-satis-sozlesmesi|iade-politikasi|cayma-hakki|on-bilgilendirme|offline|sw\\.js|sw-active|_next|_vercel|icon|apple-icon|opengraph-image|manifest|.*\\..*).*)",
  ],
};
